        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4" data-aos="fade-down" data-aos-delay="150">
                    <div class="team-member image-zoom">
                        <div class="image-zoom-wrapper">
                            <img src="{{ Vite::asset('resources/img/DENR Seminar.jpg')}}" alt="">
                        </div>
                        <h5 class="mt-4">DENR Seminar</h5>
                        <p>DENR conducted a seminar on environment preservation last October 1, 2024</p>
                        <a href="#">Read More</a>
                    </div>
                </div>
                <div class="col-md-4" data-aos="fade-down" data-aos-delay="250">
                    <div class="team-member image-zoom">
                        <div class="image-zoom-wrapper">
                            <img src="{{ Vite::asset('resources/img/Device Training.png')}}" alt="">
                        </div>
                        <h5 class="mt-4">Waste to Rewards Device Training</h5>
                        <p>Group of students officially launches their Waste to Rewards device and conducted a Training</p>
                        <a href="#">Read More</a>
                    </div>
                </div>
                <div class="col-md-4" data-aos="fade-down" data-aos-delay="350">
                    <div class="team-member image-zoom">
                        <div class="image-zoom-wrapper">
                            <img src="{{ Vite::asset('resources/img/Acquaintance.jpg')}}" alt="">
                        </div>
                        <h5 class="mt-4">Acquaintance Party</h5>
                        <p>Students escaped temporarily from their student's life as they get along in the Acquaintance Party</p>
                        <a href="#">Read More</a>
                    </div>
                </div>
            </div>
